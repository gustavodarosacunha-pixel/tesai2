...
const now = new Date();
const makeDate = (offset) => (0, date_fns_1.formatISO)((0, date_fns_1.addDays)(now, offset), { representation: 'date' });
exports.mockProjects = [
    {
        ...
        status: 'on_track',
        updatedAt: (0, date_fns_1.formatISO)(now),
    ...
    },
    {
        ...
        status: 'at_risk',
        updatedAt: (0, date_fns_1.formatISO)((0, date_fns_1.addDays)(now, -1)),
