...
type ProjectActions = {
  ...
  updateTask: (projectId: string, patch: Partial<Task> & { id: string }) => void
...
const initialProjects: Project[] = [
  {
    ...
    description: 'Entrega do MVP com dashboard responsivo e agente integrado.',
  ...
  immer((set) => ({
    ...
    createProject: (project) =>
      set((state) => {
        ...
        state.projects.push({ ...project, updatedAt: timestamp })
