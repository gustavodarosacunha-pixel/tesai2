    ...
    <div className="rounded-2xl border border-slate-200 bg-white shadow-soft">
      <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4">
        <div>
          ...
          <p className="text-sm text-slate-500">Edite diretamente na grade para atualizar datas, status e responsaveis.</p>
        </div>
        <button onClick={onAddTask} className="btn-secondary">
          + Adicionar tarefa
        </button>
      </div>
